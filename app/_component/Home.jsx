...
const Home = () => {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-white to-blue-50 p-6 md:p-12 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row-reverse items-center justify-center min-h-[80vh] gap-10">
        {/* Logo */}
        <div className="flex justify-center md:justify-end w-full md:w-1/2 animate-pulse">
          <img
